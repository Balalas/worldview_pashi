...
const CURATED_CAMERAS: PublicCamera[] = [
  ...
  { id: 'nyc-ts', name: 'Times Square 4K', lat: 40.758, lon: -73.9855, country: 'US', city: 'New York', category: 'landmark', embedUrl: 'https://www.youtube.com/embed/dzxIlgCST-4?autoplay=1&mute=1', source: 'EarthCam', heading: 180 },
  { id: 'nyc-ts2', name: 'Times Square Broadway', lat: 40.7585, lon: -73.9852, country: 'US', city: 'New York', category: 'landmark', embedUrl: 'https://www.youtube.com/embed/QTTTY_ra2Tg?autoplay=1&mute=1', source: 'EarthCam', heading: 200 },
  { id: 'nyc-liberty', name: 'Statue of Liberty', lat: 40.6892, lon: -74.0445, country: 'US', city: 'New York', category: 'landmark', embedUrl: 'https://www.youtube.com/embed/eTwqctqAyXQ?autoplay=1&mute=1', source: 'EarthCam', heading: 270 },
  { id: 'nyc-wtc', name: 'World Trade Center', lat: 40.7127, lon: -74.0134, country: 'US', city: 'New York', category: 'landmark', embedUrl: 'https://www.youtube.com/embed/2Sb9uA8R2K8?autoplay=1&mute=1', source: 'EarthCam', heading: 0 },
  { id: 'nyc-live', name: 'NYC Rolling Cam', lat: 40.7484, lon: -73.9967, country: 'US', city: 'New York', category: 'city', embedUrl: 'https://www.youtube.com/embed/fa8iGVeri_I?autoplay=1&mute=1', source: 'EarthCam', heading: 90 },
  ...
  { id: 'london-abbey', name: 'Abbey Road', lat: 51.5320, lon: -0.1783, country: 'GB', city: 'London', category: 'landmark', embedUrl: 'https://www.youtube.com/embed/j-d93A6v73Q?autoplay=1&mute=1', source: 'EarthCam', heading: 160 },
  ...
  { id: 'venice', name: 'Venice Grand Canal', lat: 45.4371, lon: 12.3326, country: 'IT', city: 'Venice', category: 'city', embedUrl: 'https://www.youtube.com/embed/QctoEW_hlJQ?autoplay=1&mute=1', source: 'I Love You Venice', heading: 90 },
  ...
  { id: 'skyline-top150', name: 'SkylineWebcams Top 150', lat: 43.7731, lon: 11.2560, country: 'IT', city: 'Florence', category: 'landmark', embedUrl: 'https://www.youtube.com/embed/rKCBKxpBVVc?autoplay=1&mute=1', source: 'SkylineWebcams', heading: 0 },
