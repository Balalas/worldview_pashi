...
export interface WorldViewState {
  ...
  // Fullscreen map mode (hide bottom panels)
...
export const useWorldViewStore = create<WorldViewState>((set) => ({
  ...
  inAppUrl: null,
  openInAppBrowser: (url) => set({ inAppUrl: url }),
  closeInAppBrowser: () => set({ inAppUrl: null }),
  ...
  fullscreenMap: false,
  toggleFullscreenMap: () => set((s) => ({ fullscreenMap: !s.fullscreenMap })),
